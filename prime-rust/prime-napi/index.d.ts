 ...
 */
export function createDefaultTrainingConfig(): TrainingConfigJs
 ...
 */
export function generateNodeId(prefix?: string | undefined | null): string
 ...
 * ```
 */
export function createTensorBuffer(data: Buffer, shape: Array<number>): TensorBuffer
 ...
 * ```
 */
export function tensorFromBuffer(buffer: Buffer, shape: Array<number>, dtype: string): TensorBuffer
 ...
 * ```
 */
export function concatenateTensors(tensors: Array<TensorBuffer>, axis: number): TensorBuffer
 ...
 * ```
 */
export function splitTensor(tensor: TensorBuffer, numSplits: number): Array<TensorBuffer>
